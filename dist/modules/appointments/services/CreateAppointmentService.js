...
let CreateAppointmenteService = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
  ...
  return (0, _tsyringe.inject)('CachProvider')(target, undefined, 2);
}, _dec5 = Reflect.metadata("design:type", Function), _dec6 = Reflect.metadata("design:paramtypes", [typeof _IAppointmentsRepository.default === "undefined" ? Object : _IAppointmentsRepository.default, typeof _INotificationsRepository.default === "undefined" ? Object : _INotificationsRepository.default, typeof _ICacheProvider.default === "undefined" ? Object : _ICacheProvider.default]), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = _dec5(_class = _dec6(_class = class CreateAppointmenteService {
  ...
  async execute({
    ...
    const dateFormatted = (0, _dateFns.format)(appointmentDate, "PP 'to' pp");
...
var _default = CreateAppointmenteService;
